...
\institute{
     ...
     Department of Psychology, Psychological Methods and Assessment, LMU Munich, Leopoldstraße 13, 80802 Munich, Germany \\
...
%             \emph{Present address:} of F. Author  %  if needed
    \and
     ...
     Department of Statistics, Statistical Learning and Data Science, LMU Munich, Ludwigstraße 33, 80539 Munich, Germany \\
     %  \\
%             \emph{Present address:} of F. Author  %  if needed
    \and
...
\date{\textbf{This preprint has since been published in Computational Statistics:} \newline Pargent, F., Pfisterer, F., Thomas, J., \& Bischl, B. Regularized target encoding outperforms traditional methods in supervised machine learning with high cardinality features. \textit{Computational Statistics} (2022). https://doi.org/10.1007/s00180-022-01207-6 \newline \textbf{Link to copy of record:} https://link.springer.com/article/10.1007/s00180-022-01207-6}
