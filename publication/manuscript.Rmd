...
Following calls for neutral benchmark studies [@boulesteix_2017], which do not introduce a new method, thus reducing the risk of cherry picking methods [@dehghani2021benchmark] and reporting over-optimistic performance [@niesl2021overoptimism], we present a carefully designed experimental setting to discern the effect of encoding strategies and their interaction with different ML algorithms.
