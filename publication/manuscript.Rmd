...
When performance differences between target encoders were observed, regularization seemed beneficial.
...
Furthermore, we observed several interesting patterns:
Integer encoding did not perform well with GB in our benchmark in contrast to what is stated in the documentation of some boosting libraries\footnote{\url{https://lightgbm.readthedocs.io/en/latest/Advanced-Topics.html\#categorical-feature-support}}.
...
<!-- heavily shorten this section or combine with others? -->
...
Furthermore, different regularization for the target based encoders seemed not to prefer strongly different HCT values.
