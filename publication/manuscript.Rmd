...
Thus, our benchmark does not include specific ordinal encoding methods like Helmert and Polynomial contrasts [@chambers_1992] which are closely related to dummy encoding or modern ordinal penalization methods [@tutz_2016].
...
Methods that can jointly encode several variables and therefore leverage correlation structures between the different variables are an interesting avenue for future research:
