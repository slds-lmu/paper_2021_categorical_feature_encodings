...
Throughout our analysis, we use implementations of the various methods for the open-source statistical software R [@r_2018].
...
All materials for this study, including reproducible code for this manuscript and the necessary result objects can be downloaded from our repository (see above).
...
We furthermore provide a more in-detail anaysis of the performances of one-hot and dummy encoding in the supplementary material.
